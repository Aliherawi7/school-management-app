...
const fa = {
    translation: {
        ...
        generateScheduleMessage: 'آیا درین باره مطمئن هستید؟',
        delete: "حذف",
        cancel: "صرف‌نظر",
        category: "دسته بندی",
        all: "همه",
        ...
        selectTheDesiredCustomer: 'شخص مورد نظر را انتخاب کنید',
        totalPrice: 'قیمت کل',
        pricePer: 'قیمت فی',
        ...
        settled: 'تسویه شده',
        customsFees: 'کرایه حمل و مصارف گمرکی',
        additionalCosts: "مصارف چکنه",
        summarize: 'جمع بندی',
        to: 'تا',
        ...
        advertisementsConsumptions: 'مصارف تبلیغات',
        generalReports: "گزارشات عمومی",
        consumptionsSummerise: 'جمله مصارفات',
        sharePercentage: 'فیصدی سهم',
        pleaseFillTheForm: 'لطفا فورم را تکمیل کنید',
        recieverEmployee: 'کارمند گیرنده',
        For: 'برای',
        securityConfiguration: 'پیکربندی امنیتی',
        userAccess: 'دسترسی های کاربر',
        config: 'پیکربندی',
        access: 'دسترسی',
        security: 'امنیتی',
        eventsReports: 'گزارشات رویدادها',
        PARTNER: 'سهامدار',
        EMPLOYEE: 'کارمند',
        userAccounts: 'حساب های کاربری',
        userAccountNotFound: "حساب کاربری یافت نشد",
        prevPassword: "رمز ورود قبلی",
        confirmNewPassword: 'تائید رمز جدید',
        showPassword: "نمایش رمز عبور",
        Logs: "گزارش رویدادها",
        DepotEvents: "رویدادهای گدام",
        updating: "در حال بروزرسانی",
        account: "حساب کاربری",
        passwordsAreNotMatched: "رمز جدید با تائید رمز یکی نیست",
        prevPasswordsAreNotMatched: "رمز ورود قبلی با رمز ورود اصلی یکی نیست",
        authInvalidCredential: "ایمیل یا رمز عبور اشتباه است",
        givenMoney: 'مقدار پول داده شده',
        givenMoneyType: "نوعیت پول داده شده",
        takenMoney: "مقدار پول گرفته شده",
        takenMoneyType: "نوعیت پول گرفته شده",
        ascending: 'صعودی',
        descending: 'نزولی',
        sort: 'ترتیب',
        exchange: "تبادل",
        dollarToAF: 'نرخ روز دالر',
        AfMoney: 'مقدار افغانی',
        dollarMoney: 'مقدار دالر',
        visitorShareOfSales: 'سهم ویزیتورها',
        paidSalaries: 'معاشات پرداخت شده',
        totalVisitorPaid: 'مجموعه بردگی های ویزیتورها',
        ...
        conditions: "شرایط",
        logs: "رویداد نگار",
        consumptionTypes: 'انواع مصارف',
        returnable: 'قابل برگشت',
        nonReturnable: 'غیرقابل برگشت',
        services: "خدمات",
        service: "خدمت",
        choose: "انتخاب کنید",
        takingOrder: "نوبت دهی",
        messaging: "پیامک",
        registrationInfo: "اطلاعات ثبت",
        info: "اطلاعات",
        registration: "ثبت",
        proficiency: "تخصص",
        contracts: "قرارداد ها",
        workTimes: "اوقات کاری",
        condition: "شرط",
        receptionNumber: "شماره نوبت",
        creatingDocument: "تشکیل پرونده",
        time: "تایم",
        // pm: "بعد از ظهر",
        pm: 'pm',
        am: 'am',
        ...
        subjects: 'مضامین',
        subject: 'مضمون',
        classNameSchedule: "تقسیم اوقات صنف",
        coefficient: "ضریب",
        resClassName: "نگران صنف",
        totalHours: "مجموع ساعات",
        totalCoefficients: "مجموع ضرایب",
        teacherInResClassIsNotEnough: "تعداد مضمون های استاد نگران کافی نیست",
        scheduleTableOfSchedule: "جدول تقسیم اوقات",
        generateRandomSchedule: "ساخت تقسیم اوقات تصادفی",
        scheduleNotExist: "تقسیم اوقات موجود نیست",


        designedAndDevelopedBy: "طراحی و توسعه",
        // developerName: `علی احمد "هــروی" `,
        developerName: `شرکت توسعه نرم افزار اتوم کد`,
        healthyProLife: "شرکت تجارتی هلتی پرو لایف",
        installMessage: 'برای تجربه کاربری بهتر اپلیکیشن را نصب کنید',
        install: "نصب"
